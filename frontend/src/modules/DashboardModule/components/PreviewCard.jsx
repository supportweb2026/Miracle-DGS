...
const PreviewState = ({ tag, value }) => {
  const hoverText = `${10 + value} factures concernées`;  // Start from 10 and increment

  const translate = useLanguage();
   const color = colours[tag] || '#595959'
  return (
    <div style={{ color: '#595959', marginBottom: 5 }}>
      ...
      <Progress percent={value} showInfo={false} strokeColor={color} title={hoverText} />
