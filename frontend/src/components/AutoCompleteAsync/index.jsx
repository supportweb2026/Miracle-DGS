...
export default function AutoCompleteAsync({
  ...
  const asyncSearch = async (options) => {
    console.log('🔍 AutoCompleteAsync - Recherche pour entity:', entity);
    console.log('🔍 AutoCompleteAsync - Options de recherche:', options);
    const result = await request.search({ entity, options });
    console.log('🔍 AutoCompleteAsync - Résultat de la recherche:', result);
    return result;
  };
  ...
  useEffect(() => {
    console.log('🔍 AutoCompleteAsync - useEffect isSuccess:', isSuccess);
    console.log('🔍 AutoCompleteAsync - useEffect result:', result);
    if (isSuccess) {
      console.log('🔍 AutoCompleteAsync - Mise à jour des options avec:', result);
      setOptions(result);
    } else {
      console.log('🔍 AutoCompleteAsync - Échec de la recherche');
      setSearching(false);
      // setCurrentValue(undefined);
      // setOptions([]);
    }
